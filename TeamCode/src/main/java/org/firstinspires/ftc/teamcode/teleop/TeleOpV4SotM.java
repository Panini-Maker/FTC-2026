    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            try {
                ...
                odoAvailable = false;
                systemError = true;
                if (ENABLE_TELEMETRY) telemetry.addLine(">>> ODOMETRY ERROR <<<");
            ...
            try {
                ...
                systemError = true;
                if (ENABLE_TELEMETRY) telemetry.addLine(">>> AUTO-AIM CALC ERROR <<<");
            }
            ...
            try {
                ...
                systemError = true;
                if (ENABLE_TELEMETRY) telemetry.addLine(">>> DRIVING/CONTROLS ERROR <<<");
            }
            ...
            try {
                ...
                systemError = true;
                if (ENABLE_TELEMETRY) telemetry.addLine(">>> SHOOTER VELOCITY READ ERROR <<<");
            }
            ...
            try {
                ...
                systemError = true;
                if (ENABLE_TELEMETRY) telemetry.addLine(">>> LATCH ERROR <<<");
            }
            ...
            try {
                ...
                systemError = true;
                if (ENABLE_TELEMETRY) telemetry.addLine(">>> HOOD ERROR <<<");
            }
            ...
            try {
                ...
                systemError = true;
                if (ENABLE_TELEMETRY) telemetry.addLine(">>> SHOOTER ERROR <<<");
            }
            ...
            try {
                ...
                systemError = true;
                if (ENABLE_TELEMETRY) telemetry.addLine(">>> INTAKE ERROR <<<");
            }
