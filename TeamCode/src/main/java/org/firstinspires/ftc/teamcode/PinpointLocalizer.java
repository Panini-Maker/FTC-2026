...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1616.3345180904362; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2304.4414778170894; // x position of the perpendicular encoder (in tick units)
    }
